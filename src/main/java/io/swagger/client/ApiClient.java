...
public class ApiClient {
    ...
    private String basePath = "http://zavijava.dia.fi.upm.es:8180/api";
...
private boolean lenientOnJson = false;
    ...
    public ApiClient() {
        ...
        httpClient.setConnectTimeout(45, TimeUnit.SECONDS); // connect timeout
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://zavijava.dia.fi.upm.es:8180/api
